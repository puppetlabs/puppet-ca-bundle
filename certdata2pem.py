...
for tobj in objects:
    if tobj['CKA_CLASS'] == 'CKO_NSS_TRUST':
        ...
        if obj != None:
            ...
            cert_fname = fname + ".crt"
            fc = open(cert_fname, 'w')
            fc.write("# alias=%s\n"%tobj['CKA_LABEL'])
            fc.write("# trust=" + " ".join(trustbits) + "\n")
            fc.write("# distrust=" + " ".join(distrustbits) + "\n")
            if openssl_trustflags:
                fc.write("# openssl-trust=" + " ".join(openssl_trustflags) + "\n")
            if openssl_distrustflags:
                fc.write("# openssl-distrust=" + " ".join(openssl_distrustflags) + "\n")
